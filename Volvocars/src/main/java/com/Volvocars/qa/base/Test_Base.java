...
import com.Volvocars.qa.extendReportListeners.ExtentReporterNG;
...
public class Test_Base {
	...
	public void setUp(Method methodName) {
		...
		util.getDriver().manage().timeouts().implicitlyWait(Duration.ofSeconds(45));
		util.getDriver().manage().timeouts().pageLoadTimeout(Duration.ofSeconds(45));
		util.getDriver().manage().window().maximize();
		util.hiturl(util.getPropertiesFile().getProperty("QA_Testing_Url"));

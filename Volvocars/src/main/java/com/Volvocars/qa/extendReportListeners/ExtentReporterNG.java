package com.Volvocars.qa.extendReportListeners;
...
public class ExtentReporterNG  {
	...
	public void initHtmlReport() {
		htmlReport = new ExtentHtmlReporter(".\\Reports\\" + time() + "_VolvoCars.html");
		htmlReport.config().setDocumentTitle("VolvoCars_ExtentReport");
		htmlReport.config().setReportName("Automation_Report");
		htmlReport.config().setTheme(Theme.DARK);

		report = new ExtentReports();
		report.attachReporter(htmlReport);
		report.setSystemInfo("Host Name", "Rinku Sahu");
